package org.example.collaborative_editor.aspect;
...
import org.example.collaborative_editor.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* org.example.collaborative_editor.mapper.*.*(..)) && @annotation(org.example.collaborative_editor.annotation.AutoFill)")
